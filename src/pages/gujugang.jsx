    ...
    return (
        <div className="bg-gray-900 text-white w-full h-full text-center">
            ...
            <section className="flex flex-wrap justify-center gap-4 p-4">
                ...
                <img src="./gujjuhouse/Location.png" alt="Location Page" className="max-w-sm rounded-lg transition-transform hover:scale-110 duration-300" />
                <img src="./gujjuhouse/Food.png" alt="Food Page" className="max-w-sm rounded-lg transition-transform hover:scale-110 duration-300" />
            ...
            <section className="py-8">
                ...
                <div className="flex justify-center gap-4">
                    <span className="bg-gray-700 px-4 py-2 rounded transition-transform hover:scale-110 hover:underline duration-300">
                        <a href="https://www.figma.com/file/PyhsFlNj0SUyFWkAqZMWky/Restaurant-app?type=design&node-id=0%3A1&mode=design&t=aBjWFY1GnmvZcRHW-1"> Figma</a>
                    </span>
                </div>
            </section>
            <Link href="/#projects" className='bg-blue-900 text-white rounded-lg  px-4 py-2'>Back</Link>
            <footer className="text-center py-4">
                <p>© 2025 GujjuHouse. All rights reserved.</p>
            </footer>
        </div>
    );
}
